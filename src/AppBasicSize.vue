<template>
    <div>
        ...
        <div class="bkh">
            ...
            <a href="//yuda-lyu.github.io/w-threejs-vue/examples/ex-AppBasicSize.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-threejs-vue/blob/master/docs/examples/ex-AppBasicSize.html" target="_blank" class="item-link">code</a>
        </div>
