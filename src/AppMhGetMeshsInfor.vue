<template>
    <div>
        ...
        <div class="bkh">
            <div style="font-size:1.5rem;">displayMeshsInfor</div>
        ...
        <div class="bkp">
            ...
            <div v-if="!loading">
                <button style="margin:0px 3px 3px 0px;" @click="displayMeshsInfor(true)">show meshsInfor</button>
                <button style="margin:0px 3px 3px 0px;" @click="displayMeshsInfor(false)">hide meshsInfor</button>
            </div>

            <div style="display:flex; padding-bottom:40px; overflow-x:auto;">

                <div style="position:relative;">
                    <div style="position:absolute; right:2px; top:1px; text-align:right; z-index:1;" v-if="c">
                        <div style="margin:0px 0px 0px 1px; padding:5px; font-size:0.75rem; color:#000; background:#eee;">
        ...
        displayMeshsInfor: function(b) {
            ...
            if (b) {
                try {
                    ...
                    console.log('displayMeshsInfor', r, c)
                }
                catch (err) {
                    console.log(err)
                }
