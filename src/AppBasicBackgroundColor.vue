            ...
            <div style="display:flex; padding-bottom:40px; overflow-x:auto;">
                ...
                <div style="position:relative;">
                    <div style="position:absolute; right:2px; top:1px; text-align:right; z-index:1;" v-if="!loading">
                        <button style="margin:0px 3px 3px 0px;" @click="setBackgroundColor('#222')">set to #222</button>
                        <button style="margin:0px 3px 3px 0px;" @click="setBackgroundColor('#263238')">set to #263238</button>
                    </div>
                    <WThreejsVue
                        :opt="opt"
                        @init="loading=false"
