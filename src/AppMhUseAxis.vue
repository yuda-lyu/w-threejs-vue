<template>
    <div>
        ...
        <div class="bkh">
            <div style="font-size:1.5rem;">useAxis</div>
            <a href="//yuda-lyu.github.io/w-threejs-vue/examples/ex-AppMhUseAxis.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-threejs-vue/blob/master/docs/examples/ex-AppMhUseAxis.html" target="_blank" class="item-link">code</a>
        </div>
            ...
            <div style="display:flex; padding-bottom:40px; overflow-x:auto;">
                ...
                <div style="position:relative;">
                    <div style="position:absolute; right:2px; top:1px; text-align:right; z-index:1;" v-if="!loading">
                        <button style="margin:0px 3px 3px 0px;" @click="setUseAxis(true)">show</button>
                        <button style="margin:0px 3px 3px 0px;" @click="setUseAxis(false)">hide</button>
                    </div>
                    <WThreejsVue
                        ref="thr"
                        :opt="opt"
