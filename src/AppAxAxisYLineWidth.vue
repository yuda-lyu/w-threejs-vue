<template>
    <div>
        ...
        <div class="bkh">
            <div style="font-size:1.5rem;">axisYLineWidth</div>
            <div style="font-size:0.7rem; color:#f26;">* WebGL renderer will always be 1</div>
            <a href="//yuda-lyu.github.io/w-threejs-vue/examples/ex-AppAxAxisYLineWidth.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-threejs-vue/blob/master/docs/examples/ex-AppAxAxisYLineWidth.html" target="_blank" class="item-link">code</a>
        </div>
            ...
            <div style="display:flex; padding-bottom:40px; overflow-x:auto;">
                ...
                <div style="position:relative;">
                    <div style="position:absolute; right:2px; top:1px; text-align:right; z-index:1;" v-if="!loading">
                        <button style="margin:0px 3px 3px 0px;" @click="setAxisYLineWidth(1)">set axisYLineWidth to 1</button>
                        <button style="margin:0px 3px 3px 0px;" @click="setAxisYLineWidth(2)">set axisYLineWidth to 2</button>
                    </div>
                    <WThreejsVue
                        ref="thr"
                        :opt="opt"
...
export default {
    ...
    methods: {
        ...
        setAxisYLineWidth: function(r) {
            let vo = this
            try {
                vo.opt.axisYLineWidth = r
            }
            catch (err) {}
        },
    },
