<template>
    <div>
        ...
        <div class="bkh">
            <div style="font-size:1.5rem;">axisXTitle</div>
            <a href="//yuda-lyu.github.io/w-threejs-vue/examples/ex-AppAxAxisXTitle.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-threejs-vue/blob/master/docs/examples/ex-AppAxAxisXTitle.html" target="_blank" class="item-link">code</a>
        </div>
