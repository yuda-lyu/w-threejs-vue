<template>
    <div>
        ...
        <div class="bkh">
            <div style="font-size:1.5rem;">cameraFar</div>
            <a href="//yuda-lyu.github.io/w-threejs-vue/examples/ex-AppCmCameraFar.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-threejs-vue/blob/master/docs/examples/ex-AppCmCameraFar.html" target="_blank" class="item-link">code</a>
        </div>
            ...
            <div style="display:flex; padding-bottom:40px; overflow-x:auto;">
                ...
                <div style="position:relative;">
                    <div style="position:absolute; right:2px; top:1px; z-index:1;" v-if="!loading">
                        <button style="margin:0px 3px 3px 0px;" @click="setCameraFar(1000)">set to 1000</button>
                        <button style="margin:0px 3px 3px 0px;" @click="setCameraFar(3)">set to 3</button>
                    </div>
                    <WThreejsVue
                        :opt="opt"
                        @init="loading=false"
