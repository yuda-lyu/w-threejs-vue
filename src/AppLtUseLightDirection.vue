<template>
    <div>
        ...
        <div class="bkp">
            ...
            <div v-if="!loading">
                <button style="margin:0px 3px 3px 0px;" @click="setUseLightDirection(true)">show</button>
                <button style="margin:0px 3px 3px 0px;" @click="setUseLightDirection(false)">hide</button>
            </div>
...
export default {
    ...
    methods: {
        ...
        setUseLightDirection: function(b) {
            let vo = this
            vo.opt.useLightDirection = b
        },
    },
}
</script>
