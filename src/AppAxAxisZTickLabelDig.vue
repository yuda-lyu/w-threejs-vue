<template>
    <div>
        ...
        <div class="bkh">
            <div style="font-size:1.5rem;">axisZTickLabelDig</div>
            <a href="//yuda-lyu.github.io/w-threejs-vue/examples/ex-AppAxAxisZTickLabelDig.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-threejs-vue/blob/master/docs/examples/ex-AppAxAxisZTickLabelDig.html" target="_blank" class="item-link">code</a>
        </div>
...
export default {
    ...
    methods: {
        ...
        setAxisZTickLabelDig: function(i) {
            let vo = this
            try {
                vo.opt.axisZTickLabelDig = i
            }
            catch (err) {}
        },
    },
